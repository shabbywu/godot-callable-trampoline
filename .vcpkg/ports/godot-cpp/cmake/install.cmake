...
set_target_properties(godot-cpp PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "$<BUILD_INTERFACE:${GODOT_CPP_SOURCE_DIR}/include>;$<BUILD_INTERFACE:${GODOT_CPP_BINARY_DIR}/gen/include>;$<BUILD_INTERFACE:${GODOT_CPP_SOURCE_DIR}/gdextension>;$<INSTALL_INTERFACE:include>" INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "$<BUILD_INTERFACE:${GODOT_CPP_SOURCE_DIR}/include>;$<BUILD_INTERFACE:${GODOT_CPP_BINARY_DIR}/gen/include>;$<BUILD_INTERFACE:${GODOT_CPP_SOURCE_DIR}/gdextension>;$<INSTALL_INTERFACE:include>")
...
install(FILES ${GODOT_CPP_SOURCE_DIR}/gdextension/gdextension_interface.h DESTINATION ${CMAKE_INSTALL_INCLUDEDIR})
install(FILES ${GODOT_CPP_SOURCE_DIR}/gdextension/extension_api.json DESTINATION ${CMAKE_INSTALL_DATADIR}/godot-cpp)

install(EXPORT godot-cpp-targets
    FILE godot-cpp-targets.cmake
    NAMESPACE godot-cpp::
    DESTINATION "${CMAKE_INSTALL_DATADIR}/godot-cpp"
)

file(READ "${GODOT_CPP_SOURCE_DIR}/gdextension/extension_api.json" GODOT_GDEXTENSION_API_JSON)
